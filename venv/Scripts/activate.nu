...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Sebastian\PycharmProjects\ISI_backend\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Sebastian\PycharmProjects\ISI_backend\venv\Scripts\deactivate.nu'
